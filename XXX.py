...
033[1;95m██╔╝╚██╗██╔╝╚██╗██033[1;95m╔╝╚██╗
033[1;95m╚═╝░░╚═╝╚═╝░░╚═╝╚═033[1;95m╝░░╚═╝
    \033[1;95m:•◈•⸎ ⸎ ⸎⸎ ⸎⸎ \033[1;91m✬✬ 👉🅰#VMK_ASAD_X_AMIT🅰👈 ✬✬ \033[1;95m⸎ ⸎⸎ ⸎ ⸎ ⸎ ⸎  ⸎ ⸎•◈••◈•     
   \033[1;95m:•◈•⸎ ⸎ ⸎⸎ ⸎⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ •◈••◈•     
  \033[1;95m:•◈•⸎ ⸎ ⸎⸎ ⸎⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ ⸎ •◈••◈•
...
jalan("\033[1;92m   ▀██▄██▀▀██▄██▀•◈•╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬•◈•▀██▄██▀▀██▄██▀   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈\033[1;91m【B】【R】【O】【T】【H】【E】【R】【S】\033[1;93m┈┈┈┈┈┈   ')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Login Completed " + username #Dev:ASAD X AMIT
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https:/https://www.youtube.com/channel/UCpfLeE7qhqT73fQ9DQz9O5g')
    else:
...
def login():
	...
	try:
		...
		tik()
		try:
			br.open('https://www.youtube.com/channel/UCpfLeE7qhqT73fQ9DQz9O5g:')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:BROTHERS_ASAD X AMIT
	print logo
...
def pilih_super():
	...
	print "\033[1;92m•◈•╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬•◈•\033[1;91m 👉💙#VMK_ASAD_X_AMIT💙👈
	 \033[1;92m•◈•╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬•◈•"
	print "  \033[1;93m«---•◈•---Developed By ASAD_X_AMIT--•◈•---»" #Dev:Z K TECH
	print '\033[1;91m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 ASAD_X_AMIT)↩\033[1;92m....'
	print"\033[1;91mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;91m"+str(len(oks))+"\033[1;97m/\033[1;92m"+str(len(7Days Ago))
	print """
